...
class VaultClient:
    ...
    def authenticate(self) -> bool:
        ...
        if not self.role_id or not self.secret_id:
            raise ValueError("AI_SERVICE_ROLE_ID and AI_SERVICE_SECRET_ID must be set")
        ...
        try:
            ...
            raise ConnectionError(f"Failed to authenticate with Vault: {e}") from e
    ...
    def read_secret(self, path: str) -> dict[str, Any]:
        ...
        try:
            ...
            secret = self.client.secrets.kv.v2.read_secret_version(path=path, mount_point="offgrid")
